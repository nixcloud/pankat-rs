#[cfg(test)]
mod tests {
    use crate::db::article::{del_by_src_file_name, get_all_articles, set};
    ...
    fn test_db_src_file_name() {
        ...
        let ret = del_by_src_file_name(&mut conn, "foo/bartest_db_set1.mdwn".to_string());
        assert!(ret.is_ok());
